<template>
  <div>
    ...
    <div class="uk-child-width-1-2 uk-box-shadow-hover-small uk-padding" uk-grid>
        <div>
          <router-link v-for="article in leftArticles" :to="{ name: 'articles-id', params: {id: article.id} }" class="uk-link-reset">
            <div class="uk-card uk-card-muted uk-box-shadow-hover-xlarge uk-padding">
    ...
    <a class="" href="https://t4ikpro.github.io/tarisapryanto.github.io">Author tarissbmptn@gmail.com</a>
